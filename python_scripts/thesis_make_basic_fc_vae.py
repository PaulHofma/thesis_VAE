...
class Decoder(nn.Module):
    def __init__(self, z_dim, h_dim):
        ...
        self.fc21 = nn.Linear(self.h_dim, 4096)
...
def small_plot(out_file, results, num_epochs, test_freq):
    ...
    axes.legend()
    fig.savefig(out_file/'elbo_plots_basic_fc.png')
    axes.set_yscale('log')
    fig.savefig(out_file/'elbo_plots_basic_fc_log.png')
...
if __name__ == '__main__':
    ...
    stringystring = "basic_fc_z="+str(Z_DIM)+"_h="+str(H_DIM)+"_N_Epochs="+str(NUM_EPOCHS)
    ...
    # save elbo prog
    stringystring1 = "ph-NOUPLOAD-T-vae_basic_fc-train_ELBO"+"_z="+str(Z_DIM)+"_h="+str(H_DIM)+"_N_Epochs="+str(NUM_EPOCHS)+".npy"
    stringystring2 = "ph-NOUPLOAD-T-vae_basic_fc-test_ELBO"+"_z="+str(Z_DIM)+"_h="+str(H_DIM)+"_N_Epochs="+str(NUM_EPOCHS)+".npy"
